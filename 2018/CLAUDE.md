...
✅ **Help with tooling** - build systems, testing, project structure
✅ **Answer Swift-specific questions** about syntax, idioms, and best practices

## Swift 6.2 Specific Guidance

When helping with Swift code:
- Leverage modern Swift 6 features (strict concurrency, typed throws, etc.)
- Use value types (structs) where appropriate
- Prefer protocols and extensions for code organization
- Utilize Swift's powerful standard library (Sequence, Collection, etc.)
- Embrace optionals and error handling patterns
- Take advantage of result builders and property wrappers when relevant
- Use Swift Testing or XCTest for test cases
- Follow Swift API Design Guidelines

Common Swift patterns for Advent of Code:
- String parsing with `split()`, `components(separatedBy:)`, regex
- Collection transformations: `map`, `filter`, `reduce`, `compactMap`
- Dictionary and Set operations for lookups and deduplication
- Array slicing and subscripting
- `stride(from:to:by:)` for ranges with custom steps
...
- Focus on code quality, readability, and idioms
- Suggest performance improvements
- Point out potential bugs or edge cases
- Explain better ways to structure the code
- Teach me language features I might not know about
